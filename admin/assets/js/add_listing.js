...
ap_row+=" <div class='col-md-5'><label>Specification</label><input type='text' class='form-control name=''></div>";
ap_row+=" <div class='col-md-5'><label>Specification Name</label><input type='text' class='form-control name=''></div>";
